...
export default function SignInForm() {
  ...
  return (
    ...
    >
      <div className='mb-8'>
        <h1 className='text-lg uppercase font-semibold text-gray-900 mb-2'>
          {source === 'checkout' ? 'Slutför din beställning' : 'Logga in'}
        </h1>
        <p className='text-gray-600 text-[15px]'>
          {source === 'checkout'
            ? 'Logga in för att spara dina uppgifter eller fortsätt som gäst'
      ...
      <div className='mt-8 '>
        {source === 'cart' || source === 'checkout' ? (
          ...
          <Link
            href='/'
            variant='underline'
            className={`flex items-center mt-10 text-[13px] gap-2 group ${isLoading ? 'opacity-50 pointer-events-none' : ''}`}
          >
